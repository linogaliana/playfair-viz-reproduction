...
```{ojs}
temp = Array({
  url: "blob:https://linogaliana.static.observableusercontent.com/66a58e01-ab7f-4254-8bac-6a01aedc3c8d",
  x: d3.timeMonth.offset( d3.min(filtered, d => d.TIME_PERIOD), 100),
  y: d3.max(filtered, d => d.OBS_VALUE_NIVEAU) - 10
})
```